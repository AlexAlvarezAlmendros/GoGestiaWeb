...
const ProtectedRoute = ({ children, requiredPermission = null, requiredRole = null }) => {
  ...
  console.log('🛡️ ProtectedRoute - Estado de protección:', {
    isAuthenticated,
    isLoading,
    requiredPermission,
    requiredRole,
  ...
  if (requiredPermission && !hasPermission(requiredPermission)) {
    console.log('❌ ProtectedRoute - Permiso denegado:', {
      requiredPermission,
    ...
    if (requiredPermission === 'create:posts' && !canCreatePosts()) {
      console.log('✏️ ProtectedRoute - No puede crear posts:', {
  ...
  if (requiredRole && !hasRole(requiredRole)) {
    console.log('👤 ProtectedRoute - Rol denegado:', {
      requiredRole,
